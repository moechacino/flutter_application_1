...
import 'package:flutter_application_1/src/screens/show_schedules_admin.dart';
import 'package:get/get.dart';
import 'form.dart';
import 'group_member.dart';
import 'tugas_admin.dart';
...
class _AdminHomeState extends State<AdminHome> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabs = [
      ...
      SevenButtonsScreen(),
      ScheduleForm(), // Menampilkan tabel jadwal kuliah
      TaskList(),
      GroupPage(),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              label: 'Edit jadwal', icon: Icon(CupertinoIcons.calendar)),
          BottomNavigationBarItem(
